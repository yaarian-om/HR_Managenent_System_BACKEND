...
import com.hr_management_system_backend.service.*;
...
public class Data_Insertion {
    ...
    public Data_Insertion(EmployeeService employeeService, ILeaveRequestRepo leaveRequestRepo,
        ...
        Data_Insertion.payrollService = payrollService;
    }
...
//        Create_Payroll();
    ...
    private static void Create_Payroll(){
        List<PayrollDTO> payrolls = Arrays.asList(
                new PayrollDTO(1L, 1L, 30000, 0, 0),
                new PayrollDTO(2L, 2L, 35000, 5000, 0),
                new PayrollDTO(3L, 3L, 28000, 2000, 0),
                new PayrollDTO(4L, 4L, 40000, 10000, 0),
                new PayrollDTO(5L, 5L, 32000, 8000, 0),
                new PayrollDTO(6L, 6L, 45000, 6000, 0),
                new PayrollDTO(7L, 7L, 28000, 3000, 0),
                new PayrollDTO(8L, 8L, 34000, 4000, 0),
                new PayrollDTO(9L, 9L, 31000, 1000, 0),
                new PayrollDTO(10L, 10L, 37000, 7000, 0)

        );

        for (PayrollDTO payment : payrolls) {
            payrollService.Create_Payroll(payment);
        }
    }
